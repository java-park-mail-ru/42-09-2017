...
public class MessageConstants {
    ...
    public static final String BAD_PASSWORD = "PASSWORD_FIELD_BAD";

    public static final String EMPTY_USERNAME = "USERNAME_FIELD_EMPTY";
    public static final String EMPTY_EMAIL = "EMAIL_FIELD_EMPTY";
    public static final String EMPTY_OLD_PASSWORD = "OLD_PASSWORD_EMPTY";
    public static final String EMPTY_PASSWORD = "PASSWORD_FIELD_EMPTY";

    public static final String SHORT_USERNAME = "USERNAME_FIELD_TOO_SHORT";
    ...
    public static final String VK_API_EXCEPTION = "VK_API_EXCEPTION";
